...
export default function NCC() {
  return (
    <article>
      <p>
        Each year, ALSET strives to introduce more kids to coding in a fun and engaging way. Sec1,
        Sec2, Sec3 students from MOE schools (junior category) and Sec4, sec5, JC, high school, ITE
        and polytechnic students (senior category) are invited to participate in ALSET for National
